...
@section('css')
    @toastr_css
@section('title')
    {{trans('Students_trans.edit_subject')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                            ...
                            <form action="{{route('subjects.update','test')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input type="text" name="Name_ar"
                                               ...
                                               class="form-control">
                                        <input type="hidden" name="idd" value="{{$subject->id}}">
                                    </div>
                                    <div class="col">
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="inputState">  {{trans('Students_trans.Educational_level')}}</label>
                                    ...
                                    <div class="form-group col">
                                        <label for="inputState"> {{trans('Students_trans.Classroom')}}</label>
