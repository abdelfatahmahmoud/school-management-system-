<div class="modal fade" id="delete_exam{{$question->id}}" tabindex="-1"
    ...
    <div class="modal-dialog" role="document">
        <form action="{{route('questionss.destroy','test')}}" method="post">
            {{method_field('delete')}}
            {{csrf_field()}}
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p> {{trans('Students_trans.Are_you_sure_with_the_deletion_process?')}}<span style="color: red">{{$question->title}}</span> </p>
