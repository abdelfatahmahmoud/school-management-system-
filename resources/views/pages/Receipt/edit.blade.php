...
@section('css')
    @toastr_css
@section('title')
    {{ trans('Students_trans.Edit_ReceiptStudent') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{ trans('Students_trans.Edit_ReceiptStudent') }} : <label style="color: red">{{$receipt_student->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{ trans('Students_trans.the_amount') }} : <span class="text-danger">*</span></label>
